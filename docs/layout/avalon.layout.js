...
define(["avalon", "../draggable/avalon.draggable", "css!./avalon.layout.css"],
    function(avalon, tpl) {
        ...
        var ewcNoTopBorder = "(northRegion.inLayoutFlow&&!northRegion.resizable&&northRegion.collspaseState=='expand')",   // 判断East, West, Centre区域是否有上边框的条件语句
            ewcNoBottomBorder = "(southRegion.inLayoutFlow&&!southRegion.resizable&&southRegion.collspaseState=='expand')",// 判断East, West, Centre区域是否有下边框的条件语句

            centreNoLeftBorder = "(westRegion.inLayoutFlow && !westRegion.resizable&&westRegion.collspaseState=='expand')",
            centreNoRightBorder = "(eastRegion.inLayoutFlow && !eastRegion.resizable&&eastRegion.collspaseState=='expand')",
            ...
            docks = {
                "north": {
                    attrBindings: {
                        "ms-if":"northRegion.collspaseState==='expand'",
                    ...
                    collspaserConfig:{
                        "ms-if":"northRegion.collspaseState==='expand'",
                        "ms-css-width": "layoutWidth",
                        "ms-css-height": "collspaseSize",
                        "ms-css-top": "layoutTop+northRegion.realSize-collspaseSize",
                        "ms-css-left": "layoutLeft"
                    },
                    expanderConfig:{
                        "ms-if":"northRegion.collspaseState==='collspase'",
                        "ms-css-width": "layoutWidth",
                        "ms-css-height": "collspaseSize",
                        "ms-css-top": "layoutTop+northRegion.realSize+(northRegion.resizeable?resizerSize:0)",
                        "ms-css-left": "layoutLeft"
                    },
                ...
                "south": {
                    attrBindings: {
                        "ms-if":"southRegion.collspaseState==='expand'",
                        "ms-css-width": "layoutWidth - (isSubLayout?0:regionBorderWidth*2)",
                    ...
                    expanderConfig:{
                        "ms-if":"southRegion.collspaseState==='collspase'",
                        "ms-css-width": "layoutWidth",
                        "ms-css-height": "collspaseSize",
                        "ms-css-top": "layoutTop+layoutHeight-southRegion.realSize-collspaseSize",
                        "ms-css-left": "layoutLeft"
                    },
                    resizerConfig: {
                        "ms-if":"southRegion.collspaseState==='expand'",
                ...
                "east": {
                    attrBindings: {
                        "ms-if":"eastRegion.collspaseState==='expand'",
                    ...
                    collspaserConfig:{
                        "ms-if":"eastRegion.collspaseState==='expand'",
                        "ms-css-width": "collspaseSize",
                        "ms-css-top": ewcRegionTop,
                        "ms-css-left": "layoutLeft+layoutWidth-eastRegion.realSize",
                        "ms-css-height": ewcResizerHeight
                    },
                    expanderConfig:{
                        "ms-if":"eastRegion.collspaseState==='collspase'",
                        "ms-css-width": "collspaseSize",
                        "ms-css-top": ewcRegionTop,
                        "ms-css-left": "layoutLeft+layoutWidth-eastRegion.realSize-collspaseSize",
                        "ms-css-height": ewcResizerHeight
                    },
                    resizerConfig: {
                        "ms-if":"eastRegion.collspaseState==='expand'",
                ...
                "west": {
                    attrBindings: {
                        "ms-if":"westRegion.collspaseState==='expand'",
                    ...
                    collspaserConfig:{
                        ...
                        "ms-css-height": ewcResizerHeight,
                        "ms-css-top": ewcRegionTop,
                        "ms-css-left": "layoutLeft+westRegion.realSize-collspaseSize"
                    },
                   expanderConfig:{
                        "ms-if":"westRegion.collspaseState==='collspase'",
                        "ms-css-width": "collspaseSize",
                        "ms-css-height": ewcResizerHeight,
                        "ms-css-top": ewcRegionTop,
                        "ms-css-left": "layoutLeft+westRegion.realSize"
        ...
        var widget = avalon.ui[widgetName] = function(element, data, vmodels) {
            ...
            var vmodel = avalon.define(data[widgetName+'Id'], function(vm) {
                ...
                avalon.mix(true, vm, {
                    ...
                    westRegion: { resizable:false, size: 0, regionClass: "", inLayoutFlow: false, isNested: false, realSize: 0, _realSize: 0,collspaseable:false,collspaseState:"expand" },
                    eastRegion: { resizable:false, size: 0, regionClass: "", inLayoutFlow: false, isNested: false, realSize: 0,_realSize: 0,collspaseable:false,collspaseState:"expand" },
                    southRegion: { resizable:false, size: 0, regionClass: "", inLayoutFlow: false, isNested: false, realSize: 0,_realSize: 0,collspaseable:false,collspaseState:"expand" },
                    northRegion: { resizable:false, size: 0, regionClass: "", inLayoutFlow: false, isNested: false, realSize: 0 ,_realSize: 0,collspaseable:false,collspaseState:"expand"}
                }, options);
                ...
                vm.$init = function() {
                    ...
                    ["northRegion", "westRegion", "eastRegion", "southRegion", "centreRegion"].forEach(function(region) {
                        ...
                        if (vm[region].inLayoutFlow) {
                            ...
                            collspaseable=vm[region].collspaseable;
                            size = vm[region].size;
                            ...
                            // }
                            vm.$bindRegionNode(regionName, vm.$dockedAreas[regionName].element, resizable,collspaseable);
                        }
                    });
                ...
                vm.$bindRegionNode = function (region, domNode, resizable,collspaseable) {
                    ...
                    if(region != 'centre' && collspaseable)
                    {
                        var resizable=false;
                        var collspaserConfig = docks[region].collspaserConfig,
                            expanderConfig=docks[region].expanderConfig,
                            collspaser = null, $collspaser = null, expander = null, $expander = null;
                        domCreator.innerHTML="<div></div><div></div>";
                        collspaser=domCreator.childNodes[0];
                        expander=domCreator.childNodes[1];
                        $collspaser=avalon(collspaser);
                        $expander=avalon(expander);
                        $collspaser.addClass("oni-layout-collspase");
                        $expander.addClass("oni-layout-collspase");
                        $collspaser.bind('click',function(e){
                            vmodel[region+"Region"]._realSize= vmodel[region+"Region"].realSize;
                            var loop=function(){
                                window.setTimeout(function(){
                                    if(vmodel[region+"Region"].realSize-1<=0){
                                        vmodel[region+"Region"].realSize=0
                                        resizable=vmodel[region+"Region"].resizable;
                                        vmodel[region+"Region"].resizable=false;
                                        vmodel[region+"Region"].collspaseState="collspase";
                                        return;
                                    }
                                    vmodel[region+"Region"].realSize=vmodel[region+"Region"].realSize-1;
                                    loop();
                                },1)
                            }
                            loop();

                            //vmodel.$element.element.removeChild(vmodel.$dockedAreas[region].element);

                            //vm.$updateNestedLayouts();
                        })
                        $expander.bind('click',function(e){
                            var offsetSize=vmodel[region+"Region"]._realSize;
                            vmodel[region+"Region"].resizable=resizable;
                            vmodel[region+"Region"].collspaseState="expand";
                            var loop=function(){
                                window.setTimeout(function(){
                                    if(offsetSize-vmodel[region+"Region"].realSize-1<=0){
                                        vmodel[region+"Region"].realSize=offsetSize
                                        return;
                                    }
                                    vmodel[region+"Region"].realSize=vmodel[region+"Region"].realSize+1;
                                    loop();
                        ...
                        for (var n in collspaserConfig) {
                            if (collspaserConfig.hasOwnProperty(n)) {
                                $collspaser.attr(n, collspaserConfig[n]);
                            }
                        }
                        for (var n in expanderConfig) {
                            if (expanderConfig.hasOwnProperty(n)) {
                                $expander.attr(n, expanderConfig[n]);
                            }
                        }
                        element.appendChild(collspaser);

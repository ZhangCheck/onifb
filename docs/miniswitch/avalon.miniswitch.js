...
define(['avalon',
    ...
    var widget = avalon.ui.miniswitch = function(element, data, vmodels) {
        ...
        var vmodel = avalon.define('miniswitch' + setTimeout("1"), function(vm) {
            ...
            vm.callUpdateScrollbar=function()
            {
                if(avalon.vmodels[data.miniswitchId].scrollWidget==null)
                {
                    avalon.vmodels[data.miniswitchId].scrollWidget=avalon.vmodels["scrollbar-" + data.miniswitchId];
                }
                avalon.vmodels[data.miniswitchId].updateScrollbar()
            }
        });

    ...
    function(avalon, sourceHTML) {
        ...
        var widget = avalon.ui.rating = function(element, data, vmodels) {
            ...
            var vmodel = avalon.define(data.ratingId, function(vm) {
                ...
                vm.notSelectedColor= '#CECECE'
                vm.selectedColor='#00A3C2'
                ...
                vm.selected=function(i){
                    if(vm.floatValue > i){
                       return 'selected_'+data.ratingId
                    }
                    return 'noselected_'+data.ratingId
                }
                ...
                vm.$init = function() {
                    ...
                    //拖动时禁止文字被选中，禁止图片被拖动
                    var cssText = ".selected_"+data.ratingId+",.selected_"+data.ratingId+">*{color:"+vm.selectedColor+";} .noselected_"+data.ratingId+",.noselected_"+data.ratingId+">*{color:"+vm.notSelectedColor+";}";
                    try {

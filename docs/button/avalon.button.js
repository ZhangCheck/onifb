        ...
        switch (options.type) {
            ...
            case "icon":
                switch (options.iconPosition) {
                    case "pause2":
                        buttonText = "<i class='oni-icon oni-icon-pause2'></i>" + "<span class='oni-button-text oni-button-text-right" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>"
                        break;
                    case "stop2":
                        buttonText = "<i class='oni-icon oni-icon-stop2'></i>" + "<span class='oni-button-text oni-button-text-right" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>"
                        break;
                    case "minus":
                        buttonText = "<i class='oni-icon oni-icon-minus'></i>" + "<span class='oni-button-text oni-button-text-right" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>"
                        break;
                    case "calendar":
                        buttonText = "<i class='oni-icon oni-icon-calendar-o'></i>" + "<span class='oni-button-text oni-button-text-right" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>"
                    break;
                    case "center":
                        buttonText = "<i class='oni-icon oni-icon-center'></i>" + "<span class='oni-button-text oni-button-text-right" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>"
                    break;
                    case "left": 
                        buttonText = "<i class='oni-icon oni-icon-left'></i>" + "<span class='oni-button-text oni-button-text-right" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>"
                    break;
                    case "right":
                        buttonText = "<span class='oni-button-text oni-button-text-left" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>" + "<i class='oni-icon oni-icon-center'></i>"
                    break;
                    case "pause2right":
                        buttonText = "<span class='oni-button-text oni-button-text-left" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>" + "<i class='oni-icon oni-icon-pause2'></i>"
                        break;
                    case "stop2right":
                        buttonText = "<span class='oni-button-text oni-button-text-left" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>" + "<i class='oni-icon oni-icon-stop2'></i>"
                        break;
                    case "minusright":
                        buttonText = "<span class='oni-button-text oni-button-text-left" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>" + "<i class='oni-icon oni-icon-minus'></i>"
                        break;
                    case "left-right":
                    /*    var iconArr = icons && icons.split("-") || ["", ""],
                            iconLeft = iconArr[0],
                            iconRight = iconArr[1]*/
                        buttonText = "<i class='oni-icon oni-icon-left'>&nbsp;</i>" + "<span class='oni-button-text oni-button-text-middle" + (!iconText ? " oni-button-text-hidden" : "") + "'>" + options.label + "</span>" + "<i class='oni-icon oni-icon-right'></i>"
                    break;
                }
            break;
        }

        //本行注释代码在ie8下不支持，使用下面的方法
        //element.innerHTML = buttonText

        element.innerHTML = "";
        element.appendChild(avalon.parseHTML(buttonText));
    }
    widget.version = 1.0
    widget.defaults = {

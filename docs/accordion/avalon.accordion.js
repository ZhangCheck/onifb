 ...
 */
define(["../avalon.getModel", "text!./avalon.accordion.html","../animation/avalon.animate", "css!../chameleon/oniui-common.css", "css!./avalon.accordion.css"], function(avalon, sourceHTML) {
        ...
        var vmodel = avalon.define(data.accordionId, function(vm) {
            ...
            vm._renderView = function(continueScan) {
                ...
                if(!options.merge){
                    ...
                    template=template.replace(/MS_OPTION_ACTIVECLASS/g, "oni-merge-state-active")
                }
    ...
    widget.defaults = {
        ...
        merge:true,//@config 默认值为true,如果为true时，只有第一个上部和最后一个下部带圆角边，且各琴键共享一条边
        /**

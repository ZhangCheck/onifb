    ...
    return {
        ...
        examples: {
            ...
            "animation": {
                ...
                "动画插件绑定":"avalon.animation.ex5.html",
                "ms-if与ms-animate联合使用":"avalon.animation.ex6.html",
                "利用after嵌套实现多个关键帧的动画":"avalon.animation.ex7.html"
            },
            "at": {
            ...
            "carousel": {
                ...
                "图片轮播组件-从接口读取图片信息": "avalon.carousel.ex9.html"
            },
            "colorpicker": {
            ...
            "simplegrid": {
                "常用例子": "avalon.simplegrid.ex1.html",
                "简单例子": "avalon.simplegrid.ex2.html",
                ...
                "演示rendCell的使用": "avalon.simplegrid.ex11.html",
                ...
                "接口内置": "avalon.simplegrid.ex19.html",
                "常规布局":"avalon.simplegrid.ex20.html",
                "自适应布局":"avalon.simplegrid.ex21.html"
            },
            "scrollspy": {
            ...
            "swipepager":{"例子":"avalon.swipepager.ex.html"},
            "imgCentral":{"例子":"avalon.imgCentral.ex.html"},
            "tab": {
            ...
            "echarts_doc":{
                "echarts简介":"avalon.echarts_doc.ex.html",
                "echarts所有参数集合:option":"avalon.echarts_doc.ex1.html",
                "timeline:时间轴":"avalon.echarts_doc.ex2.html",
                "title：标题":"avalon.echarts_doc.ex3.html",
                "toolbox：工具箱":"avalon.echarts_doc.ex4.html",
                "tooltip：提示框":"avalon.echarts_doc.ex5.html",
                "legend：图例":"avalon.echarts_doc.ex6.html",
                "dataRange：值域选择":"avalon.echarts_doc.ex7.html",
                "dataZoom：数据区域缩放":"avalon.echarts_doc.ex8.html",
                "roamController：缩放漫游":"avalon.echarts_doc.ex9.html",
                "grid:网格":"avalon.echarts_doc.ex10.html",
                "xAxis、yAxis、axis（x轴，y轴，坐标轴）":"avalon.echarts_doc.ex11.html",
                "axis.axisLine,axis.axisTick,axis.axisLabel":"avalon.echarts_doc.ex12.html",
                "axis.splitLine,axis.splitArea,data":"avalon.echarts_doc.ex13.html",
                "polar：极坐标":"avalon.echarts_doc.ex14.html",
                "series（通用、直角坐标系）":"avalon.echarts_doc.ex15.html",
                "series.data：数据部分":"avalon.echarts_doc.ex16.html",
                "series.markPoint、series.markLine：数据标注，数据标线":"avalon.echarts_doc.ex17.html",
                "itemStyle:图形样式":"avalon.echarts_doc.ex18.html",
                "lineStyle:线条样式":"avalon.echarts_doc.ex19.html",
                "areaStyle:区域填充样式":"avalon.echarts_doc.ex20.html",
                "textStyle:文字样式":"avalon.echarts_doc.ex21.html",
                "chordStyle:和弦图弦样式":"avalon.echarts_doc.ex24.html",
                "nodeStyle:力导向图节点样式":"avalon.echarts_doc.ex25.html",
                "linkStyle:力导向图边样式":"avalon.echarts_doc.ex26.html",
                "loadingOption:过渡显示":"avalon.echarts_doc.ex22.html",
                "noDataLoadingOption：无数据提示":"avalon.echarts_doc.ex23.html"
            },
            "echarts_bar":{
                "柱状图":"avalon.echarts_bar.ex.html",
                "柱状图-同一类目显示多条属性":"avalon.echarts_bar.ex1.html"
            },
            "echarts_line":{
                "堆积面积图":"avalon.echarts_line.ex.html",
                "标准折线图":"avalon.echarts_line.ex1.html"
            },
            "echarts_gauge":{
                "多仪表盘":"avalon.echarts_gauge.ex.html",
                "仪表盘":"avalon.echarts_gauge.ex1.html"
            },
            "echarts_pie":{
                "标准饼图":"avalon.echarts_pie.ex.html",
                "饼图-时间轴":"avalon.echarts_pie.ex1.html",
                "标准环形图":"avalon.echarts_pie.ex2.html",
                "嵌套饼图":"avalon.echarts_pie.ex3.html",
                "南丁格尔玫瑰图":"avalon.echarts_pie.ex4.html"

            },
            "dynamicform":{
                "示例一":"avalon.dynamicform.ex1.html"
            },
            "dynamicVM":{
                "示例":"avalon.dynamicVM.ex1.html"
            },
            "echarts_scatter":{
                "标准散点图":"avalon.echarts_scatter.ex.html",
                "标准气泡图":"avalon.echarts_scatter.ex1.html",
                "类目散点图-搭配数据区域缩放":"avalon.echarts_scatter.ex2.html",
                //"类目时间轴散点图":"avalon.echarts_scatter.ex3.html",
                "值域漫游散点图":"avalon.echarts_scatter.ex4.html"

            },
            "echarts_venn":{
                "韦恩图":"avalon.echarts_venn.ex.html"
            },
            "echarts_treemap":{
                "矩形树图":"avalon.echarts_treemap.ex.html",
                "矩形树图-数据下钻":"avalon.echarts_treemap.ex1.html"
            },
            "echarts_tree":{
                "树图":"avalon.echarts_tree.ex.html",
                "树图-节点为自定义图片":"avalon.echarts_tree.ex1.html"
            },
            "echarts_map":{
                "指定某省地图":"avalon.echarts_map.ex.html"
            },
            "echarts_mashup":{
                "仪表盘+漏斗图":"avalon.echarts_mashup.ex.html",
                "多图联动":"avalon.echarts_mashup.ex1.html"
            },
            "echarts_funnel":{
                "标准漏斗图":"avalon.echarts_funnel.ex.html",
                "标准漏斗图-数据图形间距":"avalon.echarts_funnel.ex1.html",
                "多漏斗图":"avalon.echarts_funnel.ex2.html"
            },
            "echarts_k":{
                "标准k线图":"avalon.echarts_k.ex.html",
                "k线图-多级控制":"avalon.echarts_k.ex1.html"
            },
            "formLayout":{
                "静态-表单样式布局":"avalon.formLayout.ex.html",
                "生成-表单样式布局":"avalon.formLayout.ex1.html"
            },
            "contentMiddle":{
                "内容垂直居中":"avalon.contentMiddle.ex.html"
            },
            "textBoxDialog":{
                "textBox多选择树":"avalon.textBoxDialog.ex.html"
            },
            "comboBox":{
                "comboBox合成框":"avalon.comboBox.ex.html"
            },
            "mobile":{
                "例子":"avalon.mobile.ex.html"
            },
            "treegrid":{
                "例子-节点全部展开":"avalon.treegrid.ex.html",
                "例子-节点全部收缩":"avalon.treegrid.ex1.html",
                "例子-节点根据expand字段判断是否展开":"avalon.treegrid.ex2.html"
            },
            "video":{
                "avalon范例":"avalon.video.ex1.html",
                "js范例":"avalon.video.ex2.html"
            }
        },
        apis: {
            "架构图":{
                "fb架构图":"fb.html",
                "avalon架构图":"avalon.html"
            },
            "bindings": {
            ...
            "Dom处理":{
                "AsJquery":"AsJquery/apis.html",
                "AsJquery-Examples":"AsJquery/tests.html"
            },
            "回调方法": {
        ...
        docs:{
			"fb文档":{
				"概要":"pages/index/views/doc/avalonInfo.html",
                "项目创建":"pages/index/views/doc/createProject.html",
				"OniFB起步":"pages/index/views/doc/startSample.html",
                "使用库组件":"pages/index/views/doc/libWidget.html",
                "使用项目级组件":"pages/index/views/doc/projectWidget.html",
                "自定义组件":"pages/index/views/doc/customWidget.html",
                "使用AsJQuery":"pages/index/views/apis/AsJquery/tests.html",
                "CSS规范":"pages/index/views/doc/cssStandard.html"
            },
            "核心概念": {
                "非监控属性": "pages/index/views/apis/concepts/unobservable.html",
                "监控属性": "pages/index/views/apis/concepts/observable.html",
                "监控数组": "pages/index/views/apis/concepts/collection.html",
                "计算属性": "pages/index/views/apis/concepts/computed.html",
                "watch方法": "pages/index/views/apis/concepts/$watch.html",
                "fire方法": "pages/index/views/apis/concepts/$fire.html",
                "视图模型": "pages/index/views/apis/concepts/vmodel.html",
                "数据模型": "pages/index/views/apis/concepts/$model.html"
            },
            
            "avalon文档":{
                "教程":"pages/index/views/doc/avalon.tutorial.html",
                "avalon1.4-":"pages/index/views/doc/avalon.html"
            }
        },
        tools:{
            "语言工具":{
                "WebStorm自动提示":"pages/index/views/tools/webstorm.tip.html",
                "WebStorm可视化开发":"pages/index/views/tools/webstorm.plugin.html"
            }
        },
        statics: {
